...
def test_update_product(product_controller, product_repository):
    ...
    updated_product = product_controller.update_product(
        product_id, "Updated Product", 20, False
    )
...
def test_get_products_by_quantity_range_min_only(
    product_controller, product_repository
):
...
def test_get_low_stock_products_default_threshold(
    product_controller, product_repository
):
...
def test_get_low_stock_products_custom_threshold(
    product_controller, product_repository
):
